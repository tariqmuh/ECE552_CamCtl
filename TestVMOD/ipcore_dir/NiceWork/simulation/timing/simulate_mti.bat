...
vlog -work work NiceWork_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax NiceWork_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.NiceWork_tb work.glbl
