...
xst -ifn xst.scr
move NiceWork_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\NiceWork_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc NiceWork_exdes.ucf NiceWork_exdes

echo 'Running map'
map -timing -pr b NiceWork_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm NiceWork_exdes -w routed.ncd routed.v
cd ..
